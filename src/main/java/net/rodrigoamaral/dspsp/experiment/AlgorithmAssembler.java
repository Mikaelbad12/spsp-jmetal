...
public class AlgorithmAssembler {
    ...
    private int subpopulationSize = 20;
    ...
    public AlgorithmAssembler(final String algorithmID, ExperimentSettings settings) {
        ...
        this.subpopulationSize = getValueOrDefault(settings.getSubpopulationSize(), subpopulationSize);
    ...
    public Algorithm<List<DoubleSolution>> assemble(Problem<DoubleSolution> problem) {
    	...
    	if ("NSGAII".equals(algorithmID.toUpperCase())) {
    		...
    		return new CMODEDynamicBuilder((DoubleProblem)problem)
    				...
    				.setSubpopulationSize(subpopulationSize)
    				.setMaxEvaluations(getMaxIterations())
    				.buildDefault();
    	} else if ("CMODEBIGDYNAMIC".equals(algorithmID.toUpperCase())){
    		return new CMODEDynamicBuilder((DoubleProblem)problem)
    				.setExternalArchive(externalArchive)
    				.setSubpopulationSize(subpopulationSize)
    				.setMaxEvaluations(getMaxIterations())
    				.buildDefault();
    	} else if ("CMODEREPAIRDYNAMIC".equals(algorithmID.toUpperCase())){
    		return new CMODEDynamicBuilder((DoubleProblem)problem)
    				.setUseHistoryArchive(useHistoryArchive)
    				...
    				.setMaxEvaluations(getMaxIterations())
    				.buildDefault();
    	} else if ("CMODEBIGREDYNAMIC".equals(algorithmID.toUpperCase())){
    		return new CMODEDynamicBuilder((DoubleProblem)problem)
    				.setExternalArchive(externalArchive)
    				.setEvaluateExternalArchive(evaluateExternalArchive)
    				.setSubpopulationSize(subpopulationSize)
    				.setMaxEvaluations(getMaxIterations())
    				.buildDefault();
    	} else if ("CMODEFULLREDYNAMIC".equals(algorithmID.toUpperCase())){
    		return new CMODEDynamicBuilder((DoubleProblem)problem)
    				.setExternalArchive(externalArchive)
    				.setUseHistoryArchive(useHistoryArchive)
    				.setEvaluateExternalArchive(evaluateExternalArchive)
    				...
    				.setMaxEvaluations(getMaxIterations())
    				.buildDefault();
    	} else if ("CMODEFULLDYNAMIC".equals(algorithmID.toUpperCase())){
    		return new CMODEDynamicBuilder((DoubleProblem)problem)
    				.setExternalArchive(externalArchive)
    				.setUseHistoryArchive(useHistoryArchive)
    				.setSubpopulationSize(subpopulationSize)
    		...
    		return new CMODEDynamicBuilder((DoubleProblem)problem)
    				...
    				.setMaxEvaluations(getMaxIterations())
    				.buildSDE();
    	} else if ("CMODESDEEXTERNALDYNAMIC".equals(algorithmID.toUpperCase())){
    		return new CMODEDynamicBuilder((DoubleProblem)problem)
    				.setExternalArchive(externalArchive)
    				.setSubpopulationSize(subpopulationSize)
    				.setMaxEvaluations(getMaxIterations())
    				.buildSDE();
    	}else if ("CMODESDEREPAIRDYNAMIC".equals(algorithmID.toUpperCase())){
    		return new CMODEDynamicBuilder((DoubleProblem)problem)
    				.setUseHistoryArchive(useHistoryArchive)
    				.setRepairStrategies(repairStrategies)
    				.setSubpopulationSize(subpopulationSize)
    				.setMaxEvaluations(getMaxIterations())
    				.buildSDE();
    	}else if ("CMODESDEEXTERNALREDYNAMIC".equals(algorithmID.toUpperCase())){
    		return new CMODEDynamicBuilder((DoubleProblem)problem)
    				.setExternalArchive(externalArchive)
    				.setEvaluateExternalArchive(evaluateExternalArchive)
    				.setSubpopulationSize(subpopulationSize)
    				.setMaxEvaluations(getMaxIterations())
    				.buildSDE();
    	}else if ("CMODESDEFULLREDYNAMIC".equals(algorithmID.toUpperCase())){
    		return new CMODEDynamicBuilder((DoubleProblem)problem)
    				.setExternalArchive(externalArchive)
    				.setUseHistoryArchive(useHistoryArchive)
    				.setEvaluateExternalArchive(evaluateExternalArchive)
    				...
    				.setMaxEvaluations(getMaxIterations())
    				.buildSDE();
    	}else if ("CMODESDEFULLDYNAMIC".equals(algorithmID.toUpperCase())){
    		return new CMODEDynamicBuilder((DoubleProblem)problem)
    				.setExternalArchive(externalArchive)
    				.setUseHistoryArchive(useHistoryArchive)
    				.setSubpopulationSize(subpopulationSize)
    		...
    		return new CMODEDynamicBuilder((DoubleProblem)problem)
    				...
    				.setMaxEvaluations(getMaxIterations())
    				.buildSDENorm();
    	}else if ("CMODESDENORMBIGDYNAMIC".equals(algorithmID.toUpperCase())){
    		return new CMODEDynamicBuilder((DoubleProblem)problem)
    				.setExternalArchive(externalArchive)
    				.setSubpopulationSize(subpopulationSize)
    				.setMaxEvaluations(getMaxIterations())
    				.buildSDENorm();
    	}else if ("CMODESDENORMREPAIRDYNAMIC".equals(algorithmID.toUpperCase())){
    		return new CMODEDynamicBuilder((DoubleProblem)problem)
    				.setUseHistoryArchive(useHistoryArchive)
    				.setRepairStrategies(repairStrategies)
    				.setSubpopulationSize(subpopulationSize)
    				.setMaxEvaluations(getMaxIterations())
    				.buildSDENorm();
    	}else if ("CMODESDENORMBIGREDYNAMIC".equals(algorithmID.toUpperCase())){
    		return new CMODEDynamicBuilder((DoubleProblem)problem)
    				.setExternalArchive(externalArchive)
    				.setEvaluateExternalArchive(evaluateExternalArchive)
    				.setSubpopulationSize(subpopulationSize)
    				.setMaxEvaluations(getMaxIterations())
    				.buildSDENorm();
    	}else if ("CMODESDENORMFULLREDYNAMIC".equals(algorithmID.toUpperCase())){
    		return new CMODEDynamicBuilder((DoubleProblem)problem)
    				.setExternalArchive(externalArchive)
    				.setUseHistoryArchive(useHistoryArchive)
    				.setEvaluateExternalArchive(evaluateExternalArchive)
    				...
    				.setMaxEvaluations(getMaxIterations())
    				.buildSDENorm();
    	}else if ("CMODESDENORMFULLDYNAMIC".equals(algorithmID.toUpperCase())){
    		return new CMODEDynamicBuilder((DoubleProblem)problem)
    				.setExternalArchive(externalArchive)
    				.setUseHistoryArchive(useHistoryArchive)
    				.setSubpopulationSize(subpopulationSize)
